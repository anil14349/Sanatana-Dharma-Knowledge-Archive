...
**Our Guiding Philosophy:** Research First → Understanding Second → Storytelling Third → Virality Last
...
Organized by knowledge category:

| Category | Purpose |
|----------|---------|
| **Texts** | Vedas, Upanishads, Puranas, Agamas, Smritis, Itihasa, Stotras, Tantras, Regional texts, Sahasranamas |
| **Deities** | Brahma, Vishnu, Shiva, Devi, Ganesha, Kartikeya, Hanuman, Surya, Navagraha, Other deities |
| **Temples** | Jyotirlingas, Divya Desams, Pancha Bhoota, Shakti Peethas, Temple architecture, Regional temples |
| **Philosophy** | Schools of thought, Sampradayas, Philosophical traditions |
| **Rituals & Practice** | Rituals, Mantras, Stotras, Tantras, Sacred practices |
| **Geography & Culture** | Sacred geography, Pilgrimage sites, Regional traditions, Tribal traditions, Timeline |
| **Knowledge Systems** | Astronomy, Ayurveda, Indian Knowledge Systems, Sciences |
...
- `/instagram/` — Carousel designs, reels, stories
- `/youtube/` — Video scripts, thumbnails, descriptions
- `/website/` — Articles, pages, blog posts
- `/podcast/` — Episode scripts, show notes
- `/books/` — Book chapters, outlines
...
External resources, citations, and research materials

### **Scripts & Tools** (`/scripts/` and `/tools/`)
Automation and utility scripts

### **Backlog** (`/backlog/`)
Research topics, content ideas, and pending work
...
4. Use `/content/` folders to organize by platform

### For Researchers
1. Understand the knowledge categories in [02_Master_Blueprint_v4.0.md](02_Master_Blueprint_v4.0.md)
2. Follow the research methodology in [docs/04_Research_Methodology.md](docs/04_Research_Methodology.md)
3. Structure knowledge objects using [docs/03_Knowledge_Object_Specification.md](docs/03_Knowledge_Object_Specification.md)
4. Add findings to appropriate `/knowledge/` category folders

### For Editors & Quality Assurance
...
3. Validate content using quality framework in [docs/10_AI_Architecture.md](docs/10_AI_Architecture.md)
...
- **v4.0** — Stable architecture with foundational systems established
